...
class UserPreferencesControllerTest < ActionController::TestCase
  ...
  test "should create user_preference" do
    assert_difference('UserPreference.count') do
      post :create, user_preference: { color_by_project: @user_preference.color_by_project, show_extra_color_box: @user_preference.show_extra_color_box, template: @user_preference.template, total_hours: @user_preference.total_hours, user_id: @user_preference.user_id }
    end
  ...
  test "should update user_preference" do
    patch :update, id: @user_preference, user_preference: { color_by_project: @user_preference.color_by_project, show_extra_color_box: @user_preference.show_extra_color_box, template: @user_preference.template, total_hours: @user_preference.total_hours, user_id: @user_preference.user_id }
    assert_redirected_to user_preference_path(assigns(:user_preference))
  end
